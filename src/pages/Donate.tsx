      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Your donations of seeds and e-waste help us build a sustainable ecosystem in Udaipur. 
            Every contribution, no matter how small, creates lasting environmental change.
          </p>
        </div>
        ...
        <div className="mt-16">
          <h2 className="text-3xl font-bold text-center text-gray-900 mb-8">How Your Donations Help</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white rounded-xl p-6 shadow-lg">
              <div className="text-4xl mb-4">🌱</div>
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Seeds Donation</h3>
            ...
            <div className="bg-white rounded-xl p-6 shadow-lg">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">E-Waste Recycling</h3>
              <ul className="text-gray-600 space-y-2">
